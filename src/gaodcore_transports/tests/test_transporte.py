...
@pytest.mark.parametrize("url, fields", [
    ...
    [
        "/GA_OD_Core/gaodcore-transports/aragon/drivers", {
            ...
            'active': bool,
            'activeDate': str,
            'defaultVehicleId': str
        }
    ],
    [
        "/GA_OD_Core/gaodcore-transports/aragon/live-position-latest", {
            'assetRegistration': str,
            'assetName': str,
            'assetId': str,
            'driverId': str,
            'driverName': str,
    ...
    [
        "/GA_OD_Core/gaodcore-transports/aragon/vehicle-journey-history-latest", {
            'eventDate': str,
            'vehicleId': str,
            'vehicleRegistration': str,
            'vehicleName': str,
            'vehicleGroupName': str,
            'driverId': str,
            'driverName': str,
            'driverGroupName': str,
            'eventStatus': str,
            ...
            'speed': float,
            'heading': float,
            'cumulativeRuntime': int,
            'cumulativeRuntimeType': str,
    ...
    [
        "/GA_OD_Core/gaodcore-transports/aragon/distance-travelled", {
            'assetRegistration': str,
            'assetId': str,
            'assetName': str,
            'groupName': str,
