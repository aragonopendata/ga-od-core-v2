...
class TestDownloadViewWithOperators:
    ...
    def test_download_view_without_operator(
        self, endpoint: str, client: Client, full_example
    ):
    ...
    @pytest.mark.django_db
    def test_download_view_id_with_gt_filter(
        self, endpoint: str, client: Client, full_example
    ):
        download_response = client.get(
            endpoint,
    ...
    @pytest.mark.django_db
    def test_download_view_id_with_lt_filter(
        self, endpoint: str, client: Client, full_example
    ):
        download_response = client.get(
            endpoint,
    ...
    @pytest.mark.django_db
    def test_download_view_id_with_invalid_filter(
        self, endpoint: str, client: Client, full_example
    ):
        download_response = client.get(
            endpoint,
    ...
    @pytest.mark.django_db
    def test_download_view_id_with_like_filter(
        self, endpoint: str, client: Client, full_example
    ):
    ...
    @pytest.mark.django_db
    def test_download_view_id_with_like_wrong_filter(
        self, endpoint: str, client: Client, full_example
    ):
