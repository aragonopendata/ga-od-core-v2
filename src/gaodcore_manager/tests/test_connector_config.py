...
from conftest import compare_files, ConnectorData, validate_error, get_uri


@pytest.mark.django_db
def test_connector(auth_client: Client, full_example: ConnectorData, accept_download: str):
