...
DJANGO_EASY_AUDIT_REGISTERED_URLS = [r'^/GA_OD_Core/views', r'^/GA_OD_Core/preview', r'^/GA_OD_Core/show_columns', r'/GA_OD_Core/download', r'/admin/GA_OD_Core_admin/manager/connector-config', r'/admin/GA_OD_Core_admin/manager/resource-config']
